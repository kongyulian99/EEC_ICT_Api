...
namespace EEC_ICT.Data.Core
{
    public class SqlHelper
    {
        ...
        //public static readonly string ConnectionStringProfile = ConfigurationManager.ConnectionStrings["EEC_ICTConnection"].ConnectionString;
        ...
        internal static object ExecuteReader(object p, CommandType storedProcedure, string v, SqlParameter parameter)
        {
